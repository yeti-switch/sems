...
cfg_opt_t http_action_opt[]{ CFG_STR(PARAM_ACTION_NAME, "", CFGF_NODEFAULT),
                             CFG_STR(PARAM_ACTION_ARGS_NAME, "", CFGF_NONE), CFG_END() };

cfg_opt_t http_dest_opt[]{ CFG_STR(PARAM_AUTH_TYPE, "", CFGF_NODEFAULT),
...
cfg_opt_t http_client_opt[]{ CFG_SEC(SECTION_AUTH_NAME, http_dest_opt, CFGF_MULTI | CFGF_TITLE),
