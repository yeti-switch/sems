...
TEST_F(RegistrarTest, TestRegister1)
{
    ...
    // bind Name1
    {
        ...
        test_server->addCommandResponse("FCALL register 1 %s 3600 sip:Name1@127.0.0.1:6057 %d %d Twinkle/1.10.2 %s",
            REDIS_TEST_REPLY_ARRAY, ret, registration_id.c_str(), AmConfig.node_id, req.local_if, "");
        test_server->addCommandResponse("EVALSHA %s 1 %s 3600 sip:Name1@127.0.0.1:6057 %d %d Twinkle/1.10.2 %s",
...
TEST_F(RegistrarTest, TestRegister2)
{
    ...
    // unbind Name2
    {
        ...
        AmArg ret;
        ret.assertArray();
        test_server->addCommandResponse("FCALL register 1 %s 0 sip:Name2@127.0.0.1:6057 %d %d Twinkle/1.10.2 %s",
            REDIS_TEST_REPLY_ARRAY, ret, registration_id.c_str(), AmConfig.node_id, req.local_if, "");
        test_server->addCommandResponse("EVALSHA %s 1 %s 0 sip:Name2@127.0.0.1:6057 %d %d Twinkle/1.10.2 %s",
            REDIS_TEST_REPLY_ARRAY, ret, register_script_hash, registration_id.c_str(), AmConfig.node_id, req.local_if, "");
...
TEST_F(RegistrarTest, TestRegister3)
{
    ...
    // bind Name3
    {
        ...
        test_server->addCommandResponse("FCALL register 1 %s 3600 sip:Name3@127.0.0.1:6057 %d %d Twinkle/1.10.2 %s",
            REDIS_TEST_REPLY_ARRAY, ret, registration_id.c_str(), AmConfig.node_id, req.local_if, "");
        test_server->addCommandResponse("EVALSHA %s 1 %s 3600 sip:Name3@127.0.0.1:6057 %d %d Twinkle/1.10.2 %s",
            REDIS_TEST_REPLY_ARRAY, ret, register_script_hash, registration_id.c_str(), AmConfig.node_id, req.local_if, "");
...
TEST_F(RegistrarTest, TestResolve1)
{
    ...
    // bind Name1
    {
        ...
        test_server->addCommandResponse("FCALL register 1 %s 3600 sip:Name1@127.0.0.1:6057 %d %d Twinkle/1.10.2 %s",
            REDIS_TEST_REPLY_ARRAY, ret, registration_id.c_str(), AmConfig.node_id, req.local_if, "<sip:path1.test.com;lr>");
        test_server->addCommandResponse("EVALSHA %s 1 %s 3600 sip:Name1@127.0.0.1:6057 %d %d Twinkle/1.10.2 %s",
            REDIS_TEST_REPLY_ARRAY, ret, register_script_hash, registration_id.c_str(), AmConfig.node_id, req.local_if, "<sip:path1.test.com;lr>");
