...
const char register_script_path[] = "apps/registrar/etc/register.lua";
const char aor_lookup_script_path[] = "apps/registrar/etc/aor_lookup.lua";
const char rpc_aor_lookup_script_path[] = "apps/registrar/etc/rpc_aor_lookup.lua";
const char load_contacts_script_path[] = "apps/registrar/etc/load_contacts.lua";
