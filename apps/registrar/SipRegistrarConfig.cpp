...
int SipRegistrarConfig::parse(const string &config)
{
    ...
    cfg_opt_t clickhouse_opts[]{ CFG_STR_LIST(CFG_PARAM_DESTINATIONS, 0, CFGF_NODEFAULT),
                                 CFG_STR(CFG_PARAM_TABLE, DEFAULT_TABLE, CFGF_NONE),
                                 CFG_INT(CFG_PARAM_PERIOD, DEFAULT_PERIOD, CFGF_NONE), CFG_END() };

    cfg_opt_t opts[]{ CFG_INT(CFG_PARAM_EXPIRES_MIN, 0, CFGF_NODEFAULT),
                      ...
                      CFG_BOOL(CFG_PARAM_ADD_X_AUTH_ID_HEADER, cfg_false, CFGF_NONE),
