...
protected:
    ...
    virtual void process_request_event(RedisRequestEvent &event);
...
static inline bool postRedisRequest(RedisConnection* c,
...
static inline bool postRedisRequestFmt(RedisConnection* c,
                                       const string &queue_name,
                                       const string &src_tag,
                                       bool persistent_ctx,
                                       const char *fmt...)
