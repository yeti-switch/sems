...
static cfg_opt_t acl[]{ CFG_STR_LIST(PARAM_WHITELIST, 0, CFGF_NODEFAULT), CFG_STR(PARAM_METHOD, "", CFGF_NODEFAULT),
                        CFG_END() };

cfg_opt_t prometheus_exporter_opt[]{ CFG_STR(PARAM_ADDRESS, "", CFGF_NODEFAULT),
                                     ...
                                     CFG_FUNC(PARAM_LABEL, &label_func), CFG_SEC(SECTION_ACL, acl, CFGF_NODEFAULT),
                                     CFG_END() };
