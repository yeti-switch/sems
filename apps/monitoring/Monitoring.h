...
class Monitor : public AmDynInvokeFactory, public AmConfigFactory, public AmDynInvoke {
    ...
    void listByFilter(const AmArg &args, AmArg &ret, bool erase, filter_respone_type rtype = frtype_id);
...
class MonitorGarbageCollector : public AmThread, public AmEventQueueInterface {
