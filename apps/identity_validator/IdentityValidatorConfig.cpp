...
int IdentityValidatorConfig::parse(const string &config, Configurable *obj)
{
    ...
    cfg_opt_t opts[]{ CFG_STR(CFG_PARAM_HTTP_DESTINATIION, DEFAULT_HTTP_DESTINATIION, CFGF_NONE),
                      ...
                      CFG_INT(CFG_PARAM_CRL_CACHE_RENEW_TIMEOUT, DEFAULT_CRL_CACHE_RENEW_TIMEOUT, CFGF_NONE),
                      CFG_INT(CFG_PARAM_CRL_CACHE_IDLE_TIMEOUT, DEFAULT_CRL_CACHE_IDLE_TIMEOUT, CFGF_NONE),
                      CFG_BOOL(CFG_PARAM_CRL_PROCRSSING, DEFAULT_CRL_PROCRSSING, CFGF_NONE),
