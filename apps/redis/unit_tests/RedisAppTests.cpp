...
TEST_F(RedisTest, RedisAppConnectScript1)
{
    ...
    {
        RedisScript script("load_contacts", "/etc/sems/scripts/load_contacts.lua");
...
TEST_F(RedisTest, RedisAppConnectScript2)
{
    ...
    {
        RedisScript script1("register", "/etc/sems/scripts/register.lua");
        RedisScript script2("aor_lookup", "/etc/sems/scripts/aor_lookup.lua");
        RedisScript script3("rpc_aor_lookup", "/etc/sems/scripts/rpc_aor_lookup.lua");
        RedisScript script4("load_contacts", "/etc/sems/scripts/load_contacts.lua");
