...
{
    cfg_opt_t opts[] = { CFG_BOOL(PARAM_EXT_REDIS_NAME, cfg_false, CFGF_NONE),
    ...
    config_parameters.emplace<string, TesterConfig::parameter_var>(
        PARAM_EXT_REDIS_NAME "-" SECTION_REDIS_NAME,
        { .type = TesterConfig::parameter_var::Bool, .u = { &settings.external } });
    config_parameters.emplace<string, TesterConfig::parameter_var>(
