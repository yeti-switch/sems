...
class RadiusClient : public AmDynInvokeFactory,
                     public AmThread,
  ...
  public:
    ...
    int  addAuthConnection(unsigned int connection_id, string name, string server, unsigned short port, string secret,
                           bool reject_on_error, unsigned int timeout_msec, unsigned int attempts, AmArg avps);
    ...
    int  addAccConnection(unsigned int connection_id, string name, string server, unsigned short port, string secret,
                          unsigned int timeout_msec, unsigned int attempts, AmArg start_avps, AmArg interim_avps,
                          AmArg stop_avps, bool enable_start_accounting, bool enable_interim_accounting,
