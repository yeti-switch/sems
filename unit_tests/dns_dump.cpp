...
static const unsigned char _sip_udp_test_invalid_cl1_type33[] = {
  0x3B,0xE1,0x85,0x80,0x00,0x01,0x00,0x01, 0x00,0x00,0x00,0x00,0x04,0x5F,0x73,0x69, // |  ;............_si
  0x70,0x04,0x5F,0x75,0x64,0x70,0x04,0x74, 0x65,0x73,0x74,0x07,0x69,0x6E,0x76,0x61, // |  p._udp.test.inva
  0x6C,0x69,0x64,0x00,0x00,0x21,0x00,0x01, 0xC0,0x0C,0x00,0x21,0x00,0x01,0x00,0x00, // |  lid..!.....!....
  0x00,0x3C,0x00,0x14,0x00,0x00,0x00,0x00, 0x13,0xC4,0x04,0x74,0x65,0x73,0x74,0x07, // |  .<.........test.
...
static const unsigned char test_invalid_cl1_type1[] = {
  0xDA,0x08,0x85,0x80,0x00,0x01,0x00,0x01, 0x00,0x00,0x00,0x00,0x04,0x74,0x65,0x73, // |  .............tes
  0x74,0x07,0x69,0x6E,0x76,0x61,0x6C,0x69, 0x64,0x00,0x00,0x01,0x00,0x01,0xC0,0x0C, // |  t.invalid.......
...
static const unsigned char test_invalid_cl1_type28[] = {
  0xE3,0x75,0x85,0x80,0x00,0x01,0x00,0x01, 0x00,0x00,0x00,0x00,0x04,0x74,0x65,0x73, // |  .u...........tes
  0x74,0x07,0x69,0x6E,0x76,0x61,0x6C,0x69, 0x64,0x00,0x00,0x1C,0x00,0x01,0xC0,0x0C, // |  t.invalid.......
  0x00,0x1C,0x00,0x01,0x00,0x00,0x00,0x00, 0x00,0x10,0x00,0x00,0x00,0x00,0x00,0x00, // |  ................
  0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00, 0x00,0x01                                // |  ..........
};

struct ns_key {
    std::string dname; int cl, type;
    auto operator<=>(const ns_key&) const = default;
    ns_key(std::string_view dname, int cl, int type)
      : dname{dname}, cl{cl}, type{type} {}
};
using ns_entity = std::basic_string_view<unsigned char>;

std::map<ns_key, ns_entity> ns_db = {
  { {"_sip._udp.test.invalid", ns_c_in, ns_t_srv}, {_sip_udp_test_invalid_cl1_type33, sizeof _sip_udp_test_invalid_cl1_type33} },
...
int dns_dump_res_search(const char *dname, int cl, int type, unsigned char *answer, int anslen) __THROW
{
    ...
    bool real = false;
    if(ret < 0) real = true, ret = real_res_search(dname, cl, type, answer, anslen);
