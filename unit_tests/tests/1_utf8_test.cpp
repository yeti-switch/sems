...
class Validator : public testing::TestWithParam<TestUtf8ValidateDataType> {
  protected:
...
INSTANTIATE_TEST_SUITE_P(
    Utf8, Validator,
    testing::Values(std::make_tuple("<>", true, "<>"), std::make_tuple("\xF5>", false, ">"),
                    std::make_tuple("<\xF5>", false, "<>"), std::make_tuple("<\xF5\xF5>", false, "<>"),
                    std::make_tuple("<\xC3\xA6>", true, "<\xC3\xA6>"), std::make_tuple("<\xC3\x70>", false, "<p>"),
                    std::make_tuple("<\xE0\xA0\x70>", false, "<p>"), std::make_tuple("\xE0\xA0\x70>", false, "p>"),
                    ...
                    std::make_tuple("<\xF0\x90\x80\x79>", false, "<y>"), std::make_tuple("<\xE4>", false, "<>"),
                    std::make_tuple("<\xE4|\xE4>", false, "<|>"), std::make_tuple("\xF0", false, ""),
                    std::make_tuple("<\xF0", false, "<"), std::make_tuple("<\xF0\x90", false, "<"),
                    std::make_tuple("<\xF0\x90\x80", false, "<"), std::make_tuple("\xF0\x90\x80", false, "")));
