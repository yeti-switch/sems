...
{
    return (uri_user == c.uri_user) && (!strcasecmp(uri_host.c_str(), c.uri_host.c_str())) && (uri_port == c.uri_port);
}
...
static inline int skip_uri(const string &s, unsigned int pos)
{
    ...
    while (len) {
        ...
        case '<':
            ...
            case ST3: DBG("ERROR skip_uri(): Second < found"); return -1;
            case ST5: st = ST2; break;
            case ST6: st = ST4; break;
            }
            break;
        ...
        case '>':
            switch (st) {
            case ST1: DBG("ERROR skip_uri(): > is first"); return -2;
...
bool AmUriParser::parse_uri()
{
    ...
    size_t      p1  = 0;
    int         eq = 0, eq1 = 0;
    const char *sip_prot = "SIP:", *sip_prot1 = "SIPS:";
    uri_user  = "";
    uri_host  = "";
    uri_port  = "";
    uri_param = "";
...
string AmUriParser::add_param_to_param_list(const string &param_name, const string &param_value,
