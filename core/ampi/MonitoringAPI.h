...
#define MONITORING_ADD_SAMPLE_NOW(type, name, _now) MONITORING_ADD_SAMPLE_VALUE_NOW(type, name, 1, _now)

#define MONITORING_ADD_SAMPLE(type, name) MONITORING_ADD_SAMPLE_VALUE(type, name, 1)
...
#define MONITORING_GET_COUNT(type, name, _ret) MONITORING_GET_COUNT_SEC(type, name, 1, _ret)
...
#define MONITORING_GET_ALL_COUNTS(type, _ret) MONITORING_GET_ALL_COUNTS_SEC(type, 1, _ret)
