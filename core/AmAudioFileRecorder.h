...
class AmAudioFileRecorder {
  ...
  public:
    ...
    virtual void writeSamples([[maybe_unused]] unsigned char *samples, [[maybe_unused]] size_t size,
                              [[maybe_unused]] int input_sample_rate)
    {
        throw std::logic_error("not implemented");
    }

    virtual void writeStereoSamples([[maybe_unused]] unsigned long long ts, [[maybe_unused]] unsigned char *samples,
                                    [[maybe_unused]] size_t size, [[maybe_unused]] int input_sample_rate,
                                    [[maybe_unused]] int channel_id)
    {
        throw std::logic_error("not implemented");
    }

    virtual void setTag([[maybe_unused]] unsigned int channel_id, [[maybe_unused]] unsigned int tag)
    {
        throw std::logic_error("not implemented");
    }
...
struct AudioRecorderEvent {
    ...
    enum recorder_class { RecorderClassMono, RecorderClassStereo };
...
struct AudioRecorderCtlEvent : AudioRecorderEvent {
    ...
    AudioRecorderCtlEvent(const string &recorder_id, event_type event_id, AmAudioFileRecorder::RecorderType rtype,
...
struct AudioRecorderSetTagEvent : AudioRecorderEvent {
    unsigned int channel_id;
    unsigned int tag;

    AudioRecorderSetTagEvent(const string &recorder_id, event_type event_id, unsigned int channel_id, unsigned int tag)
        : AudioRecorderEvent(recorder_id, event_id)
...
class _AmAudioFileRecorderProcessor : public AmThread, AmEventHandler, AmEventFdQueue {
    int epoll_fd;
    ...
    long long int recorders_opened, recorders_closed;
