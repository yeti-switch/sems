...
int zrtpContext::onActivated(const bzrtpSrtpSecrets_t *srtpSecrets)
{
    ...
    memcpy(local_key.data() + srtpSecrets->selfSrtpKeyLength, srtpSecrets->selfSrtpSalt, srtpSecrets->selfSrtpSaltLength);
    memcpy(remote_key.data(), srtpSecrets->peerSrtpKey, srtpSecrets->peerSrtpKeyLength);
    memcpy(remote_key.data() + srtpSecrets->peerSrtpKeyLength, srtpSecrets->peerSrtpSalt, srtpSecrets->peerSrtpSaltLength);
