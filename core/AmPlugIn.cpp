...
static unsigned int pcm16_samples2bytes([[maybe_unused]] long h_codec, unsigned int num_samples)
{
    return num_samples * 2;
}

static unsigned int tevent_bytes2samples([[maybe_unused]] long h_codec, unsigned int num_bytes)
{
    return num_bytes;
}

static unsigned int tevent_samples2bytes([[maybe_unused]] long h_codec, unsigned int num_samples)
{
    return num_samples;
}
