...
BEGIN_EXPORTS("amr", AMCI_NO_MODULEINIT, AMCI_NO_MODULEDESTROY)
    ...
    BEGIN_CODECS
        CODEC/*_VARIABLE_FRAMES*/(CODEC_AMR, pcm16_2_amr, amr_2_pcm16, AMCI_NO_CODEC_PLC,
            (amci_codec_init_t) amr_create, (amci_codec_destroy_t) amr_destroy,
            amr_bytes2samples, amr_samples2bytes//, amr_frames2samples
            )
        CODEC/*_VARIABLE_FRAMES*/(CODEC_AMRWB, pcm16_2_amrwb, amrwb_2_pcm16, AMCI_NO_CODEC_PLC,
            (amci_codec_init_t) amrwb_create, (amci_codec_destroy_t) amrwb_destroy,
            amrwb_bytes2samples, amrwb_samples2bytes//, amrwb_frames2samples
            )
    END_CODECS
