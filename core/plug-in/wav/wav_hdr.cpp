...
#define bswap_32(A)                                                                                                    \
    ((((u_int32_t)(A) & 0xff000000) >> 24) | (((u_int32_t)(A) & 0x00ff0000) >> 8) |                                    \
     (((u_int32_t)(A) & 0x0000ff00) << 8) | (((u_int32_t)(A) & 0x000000ff) << 24))
#define cpu_to_le16(x) bswap_16(x)
#define le_to_cpu16(x) bswap_16(x)
#define cpu_to_le32(x) bswap_32(x)
#define le_to_cpu32(x) bswap_32(x)
#elif (defined(__BYTE_ORDER) && (__BYTE_ORDER == __LITTLE_ENDIAN)) || defined(_LITTLE_ENDIAN) ||                       \
    defined(__LITTLE_ENDIAN) || (defined(BYTE_ORDER) && (BYTE_ORDER == LITTLE_ENDIAN))
