...
static int Pcm16_2_L16(unsigned char *out_buf, unsigned char *in_buf, unsigned int size, unsigned int channels,
                       unsigned int rate, long h_codec);

static int L16_2_Pcm16(unsigned char *out_buf, unsigned char *in_buf, unsigned int size, unsigned int channels,
                       unsigned int rate, long h_codec);
...
BEGIN_CODECS
CODEC(CODEC_L16, Pcm16_2_L16, L16_2_Pcm16, AMCI_NO_CODEC_PLC, AMCI_NO_CODECCREATE, AMCI_NO_CODECDESTROY,
