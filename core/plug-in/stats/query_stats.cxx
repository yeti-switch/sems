...
static int parse_args(int argc, char *argv[], const string &flags, const string &options, std::map<char, string> &args);
...
int main(int argc, char **argv)
{
    ...
    err = sendto(sd, msg_buf.c_str(), msg_buf.length(), 0, (const struct sockaddr *)&addr, sizeof(struct sockaddr_in));
