 ...
 */
static void WebRtcIsac_AllPassFilter2Float(float *InOut, const float *APSectionFactors, int lengthInOut,
                                           int NumberOfSections, float *FilterState)
{
    int   n, j;
    float temp;
...
static const float kHpStCoefInFloat[4] = { -1.94895953203325f, 0.94984516000000f, -0.05101826139794f,
                                           0.05015484000000f };
 ...
 * This function creates low-pass and high-pass decimated versions of part of
 ...
 encoding iteration.
*/
void WebRtcIsac_SplitAndFilterFloat(float *pin, float *LP, float *HP, double *LP_la, double *HP_la,
                                    PreFiltBankstr *prefiltdata)
{
    ...
    */
    ...
    WebRtcIsac_AllPassFilter2Float(tempinoutvec, WebRtcIsac_kCompositeApFactorsFloat, FRAMESAMPLES_HALF,
    ...
    WebRtcIsac_AllPassFilter2Float(prefiltdata->INLABUF1_float, WebRtcIsac_kCompositeApFactorsFloat, QLOOKAHEAD,
                                   NUMBEROFCOMPOSITEAPSECTIONS, CompositeAPFilterState);
    ...
    WebRtcIsac_AllPassFilter2Float(prefiltdata->INLABUF2_float, WebRtcIsac_kCompositeApFactorsFloat, QLOOKAHEAD,
                                   NUMBEROFCOMPOSITEAPSECTIONS, CompositeAPFilterState);
    ...
    for (k = 0; k < NUMBEROFCHANNELAPSECTIONS; k++) {       /* k is row variable */
        for (n = 0; n < NUMBEROFCOMPOSITEAPSECTIONS; n++) { /* n is column variable */
            prefiltdata->INSTAT1_float[k] +=
                ForTransform_CompositeAPFilterState[n] * WebRtcIsac_kTransform1Float[k * NUMBEROFCHANNELAPSECTIONS + n];
    ...
    WebRtcIsac_AllPassFilter2Float(tempin_ch1, WebRtcIsac_kUpperApFactorsFloat, FRAMESAMPLES_HALF,
                                   NUMBEROFCHANNELAPSECTIONS, prefiltdata->INSTAT1_float);
    WebRtcIsac_AllPassFilter2Float(tempin_ch2, WebRtcIsac_kLowerApFactorsFloat, FRAMESAMPLES_HALF,
                                   NUMBEROFCHANNELAPSECTIONS, prefiltdata->INSTAT2_float);
    ...
    WebRtcIsac_AllPassFilter2Float(tempin_ch1, WebRtcIsac_kUpperApFactorsFloat, FRAMESAMPLES_HALF,
                                   NUMBEROFCHANNELAPSECTIONS, prefiltdata->INSTATLA1_float);
    WebRtcIsac_AllPassFilter2Float(tempin_ch2, WebRtcIsac_kLowerApFactorsFloat, FRAMESAMPLES_HALF,
                                   NUMBEROFCHANNELAPSECTIONS, prefiltdata->INSTATLA2_float);
...
static const float kHpStCoefOut1Float[4] = { -1.99701049409000f, 0.99714204490000f, 0.01701049409000f,
                                             -0.01704204490000f };

/* HPstcoeff_out_2 = {a1, a2, b1 - b0 * a1, b2 - b0 * a2}; */
static const float kHpStCoefOut2Float[4] = { -1.98645294509837f, 0.98672435560000f, 0.00645294509837f,
                                             -0.00662435560000f };
...
void WebRtcIsac_FilterAndCombineFloat(float *InLP, float *InHP, float *Out, PostFiltBankstr *postfiltdata)
{
    ...
    WebRtcIsac_AllPassFilter2Float(tempin_ch1, WebRtcIsac_kLowerApFactorsFloat, FRAMESAMPLES_HALF,
                                   NUMBEROFCHANNELAPSECTIONS, postfiltdata->STATE_0_UPPER_float);
    ...
    WebRtcIsac_AllPassFilter2Float(tempin_ch2, WebRtcIsac_kUpperApFactorsFloat, FRAMESAMPLES_HALF,
                                   NUMBEROFCHANNELAPSECTIONS, postfiltdata->STATE_0_LOWER_float);
