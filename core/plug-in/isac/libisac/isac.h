...
WebRtc_Word16 WebRtcIsac_Assign(ISACStruct **ISAC_main_inst, void *ISAC_inst_Addr);
...
WebRtc_Word16 WebRtcIsac_Decode(ISACStruct *ISAC_main_inst, const WebRtc_UWord16 *encoded, WebRtc_Word16 len,
...
WebRtc_Word16 WebRtcIsac_Control(ISACStruct *ISAC_main_inst, WebRtc_Word32 rate, WebRtc_Word16 framesize);
...
WebRtc_Word16 WebRtcIsac_ControlBwe(ISACStruct *ISAC_main_inst, WebRtc_Word32 rateBPS, WebRtc_Word16 frameSizeMs,
 ...
 *                             -1 - Error
 */
WebRtc_Word16 WebRtcIsac_DecodeRcu(ISACStruct *ISAC_main_inst, const WebRtc_UWord16 *encoded, WebRtc_Word16 len,
                                   WebRtc_Word16 *decoded, WebRtc_Word16 *speechType);
