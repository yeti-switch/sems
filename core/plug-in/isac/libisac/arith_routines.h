...
int WebRtcIsac_EncLogisticMulti2(Bitstr               *streamdata, /* in-/output struct containing bitstream */
...
int WebRtcIsac_DecLogisticMulti2(WebRtc_Word16        *data,       /* output: data vector */
