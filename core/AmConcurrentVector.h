...
template <typename Item> void StandartDeleter(Item *item)
{
    delete item;
}

template <typename Item> void ReferenceDeleter(Item *item)
{
    dec_ref(item);
}

template <typename Item> void ReferenceInserter(Item *item)
{
    inc_ref(item);
}
