...
class AmMediaConnectionFactory {
  private:
    ...
    AmStreamConnection *createSrtpConnection(const string &raddr, int rport, int srtp_profile, const string &local_key,
  ...
  public:
    ...
    // create-funcs
    AmStreamConnection *createStunConnection(const string &raddr, int rport, unsigned int lpriority,
                                             unsigned int priority = 0);
    AmStreamConnection *createDtlsConnection(const string &raddr, int rport, DtlsContext *context);
    ...
    AmStreamConnection *createZrtpConnection(const string &raddr, int rport, zrtpContext *context);
    ...
    AmStreamConnection *createDtlsUdptlConnection(const string &raddr, int rport, AmStreamConnection *dtls);
};
