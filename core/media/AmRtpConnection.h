...
class AmStreamConnection : public atomic_ref_cnt
...
#endif
{
  public:
    ...
    virtual void    process_packet(uint8_t *data, unsigned int size, struct sockaddr_storage *recv_addr,
    ...
    {
        memcpy(addr, &r_addr, sizeof(sockaddr_storage));
    }
    bool isMute()
    {
        return mute;
    }
    AmMediaTransport *getTransport()
    {
        return transport;
    }
