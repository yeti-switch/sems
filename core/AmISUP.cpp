...
static void dump_buffer(const char *prefix, char *buf, size_t len)
{
    ...
    DBG("%s:\n%s", prefix, s.str().c_str());
}

static const char *proto_type_get_str(AmISUP::isup_proto_type proto)
{
    switch (proto) {
    case AmISUP::SS7_ITU:     return "ITU"; break;
    case AmISUP::SS7_ANSI:    return "ANSI"; break;
    case AmISUP::SS7_UNKNOWN:
    default:                  return "Unknown"; break;
    }
}

enum isup_parm_type { PARM_TYPE_FIXED = 1, PARM_TYPE_VARIABLE, PARM_TYPE_OPTIONAL };
...
static int iam_params[] = { ISUP_PARM_NATURE_OF_CONNECTION_IND,
                            ISUP_PARM_FORWARD_CALL_IND,
                            ISUP_PARM_CALLING_PARTY_CAT,
                            ISUP_PARM_TRANSMISSION_MEDIUM_REQS,
                            ISUP_PARM_CALLED_PARTY_NUM,
                            ISUP_PARM_CALLING_PARTY_NUM,
                            -1 };

static int ansi_iam_params[] = { ISUP_PARM_NATURE_OF_CONNECTION_IND,
                                 ISUP_PARM_FORWARD_CALL_IND,
                                 ISUP_PARM_CALLING_PARTY_CAT,
                                 ISUP_PARM_USER_SERVICE_INFO,
                                 ISUP_PARM_CALLED_PARTY_NUM,
                                 ISUP_PARM_CALLING_PARTY_NUM,
                                 ISUP_PARM_CHARGE_NUMBER,
                                 ISUP_PARM_ORIG_LINE_INFO,
                                 ISUP_PARM_GENERIC_ADDR,
                                 ISUP_PARM_GENERIC_DIGITS,
                                 ISUP_PARM_GENERIC_NAME,
                                 ISUP_PARM_JIP,
                                 ISUP_PARM_LOCAL_SERVICE_PROVIDER_IDENTIFICATION,
                                 -1 };
...
{
    switch (message) {
    case ISUP_UNDEF: return "UNDEFINED";
    ...
    case ISUP_BLO:   return "BLO";
    case ISUP_UBL:   return "UBL";
    case ISUP_BLA:   return "BLA";
    case ISUP_UBA:   return "UBA";
    case ISUP_CGB:   return "CGB";
    case ISUP_CGU:   return "CGU";
    case ISUP_CGBA:  return "CGBA";
    case ISUP_CGUA:  return "CGUA";
    case ISUP_RSC:   return "RSC";
    case ISUP_CPG:   return "CPG";
    case ISUP_UCIC:  return "UCIC";
    case ISUP_LPA:   return "LPA";
    case ISUP_FAA:   return "FAA";
    case ISUP_FAR:   return "FAR";
    case ISUP_FRJ:   return "FRJ";
    case ISUP_CVT:   return "CVT";
    case ISUP_CVR:   return "CVR";
    case ISUP_CFN:   return "CFN";
...
static FUNC_DUMP(nature_of_connection_ind_dump)
{
    ...
    con >>= 2;
    switch (con & 0x03) {
    case 0: continuity = (char *)"Check not required"; break;
    case 1: continuity = (char *)"Check required on this circuit"; break;
    case 2: continuity = (char *)"Check performed on a previous circuit"; break;
    case 3: continuity = (char *)"spare"; break;
    }
...
static FUNC_DUMP(forward_call_ind_dump)
{
    ...
    switch ((parm[0] >> 1) & 3) {
    case 0: cb_str = (char *)"no end-to-end"; break;
    case 1: cb_str = (char *)"pass-along"; break;
    case 2: cb_str = (char *)"SCCP"; break;
    case 3: cb_str = (char *)"pass-along and SCCP"; break;
    }

    switch ((parm[0] >> 6) & 3) {
    case 0: hg_str = (char *)"ISDN user part preferred all the way"; break;
    case 1: hg_str = (char *)"ISDN user part not preferred all the way"; break;
    case 2: hg_str = (char *)"ISDN user part required all the way"; break;
    case 3: hg_str = (char *)"spare"; break;
    }

    switch ((parm[1] >> 1) & 3) {
    case 0: kj_str = (char *)"no indication"; break;
    case 1: kj_str = (char *)"connectionless method available"; break;
    case 2: kj_str = (char *)"connection oriented method available"; break;
    case 3: kj_str = (char *)"connectionless and connection oriented method available"; break;
    }

    DBG("\tNat/Intl Call Ind: call to be treated as a %s call (%d)", (parm[0] & 1) ? "international" : "national",
        parm[0] & 1);
    ...
    DBG("\tEnd to End Info Ind: %send-to-end information available (%d)", ((parm[0] >> 4) & 1) ? "" : "no ",
        (parm[0] >> 4) & 1);
    DBG("\tISDN User Part Ind: ISDN user part %sused all the way (%d)", ((parm[0] >> 5) & 1) ? "" : "not ",
        (parm[0] >> 5) & 1);
...
static FUNC_DUMP(calling_party_cat_dump)
{
    ...
    switch (parm[0]) {
    case 1:  cattype = (char *)"Operator, French"; break;
    case 2:  cattype = (char *)"Operator, English"; break;
    case 3:  cattype = (char *)"Operator, German"; break;
    case 4:  cattype = (char *)"Operator, Russian"; break;
    case 5:  cattype = (char *)"Operator, Spanish"; break;
    case 9:  cattype = (char *)"Reserved"; break;
    case 10: cattype = (char *)"Ordinary calling subscriber"; break;
    case 11: cattype = (char *)"Calling subscriber with priority"; break;
    case 12: cattype = (char *)"Data Call (voice band data)"; break;
    case 13: cattype = (char *)"Test Call"; break;
    case 15: cattype = (char *)"Payphone"; break;
    default: cattype = (char *)"Unknown"; break;
    }
...
static FUNC_DUMP(transmission_medium_reqs_dump)
{
    ...
    switch (parm[0]) {
    case 0:  type = (char *)"Speech"; break;
    case 1:  type = (char *)"Spare"; break;
    case 2:  type = (char *)"64 kbit/s unrestricted"; break;
    case 4:  type = (char *)"3.1 khz audio"; break;
    case 6:  type = (char *)"64 kbit/s preferred"; break;
    case 7:  type = (char *)"2 x 64 kbit/s unrestricted"; break;
    case 8:  type = (char *)"384 kbit/s unrestricted"; break;
    case 9:  type = (char *)"1536 kbit/s unrestricted"; break;
    case 10: type = (char *)"1920 kbit/s unrestricted"; break;
    default: type = (char *)"N x 64kbit/s unrestricted or possibly spare"; break;
    }
    DBG("\t%s (%d)", type, parm[0]);
    return 1;
}
...
static FUNC_DUMP(cause_dump)
{
    char *cause;
    switch (parm[1] & 0x7f) {
    case 1:  cause = (char *)"Unallocated (unassigned) number"; break;
    case 2:  cause = (char *)"No route to specified transit network"; break;
    case 3:  cause = (char *)"No route to destination"; break;
    case 4:  cause = (char *)"Send special information tone"; break;
    case 5:  cause = (char *)"Misdialled trunk prefix"; break;
    case 6:  cause = (char *)"Channel unacceptable"; break;
    case 7:  cause = (char *)"Call awarded and being delivered in an established channel"; break;
    case 8:  cause = (char *)"Preemption"; break;
    case 9:  cause = (char *)"Preemption - circuit reserved for reuse"; break;
    case 16: cause = (char *)"Normal call clearing"; break;
    case 17: cause = (char *)"User busy"; break;
    case 18: cause = (char *)"No user responding"; break;
    case 19: cause = (char *)"No answer from user (user alerted)"; break;
    case 20: cause = (char *)"Subscriber absent"; break;
    case 21: cause = (char *)"Call rejected"; break;
    case 22: cause = (char *)"Number changed"; break;
    case 23: cause = (char *)"Redirection to new destination"; break;
    case 25: cause = (char *)"Exchange routing error"; break;
    case 26: cause = (char *)"Non-selected user clearing"; break;
    case 27: cause = (char *)"Destination out of order"; break;
    case 28: cause = (char *)"Invalid number format (address incomplete)"; break;
    case 29: cause = (char *)"Facility rejected"; break;
    case 30: cause = (char *)"Response to STATUS ENQUIRY"; break;
    case 31: cause = (char *)"Normal, unspecified"; break;
    case 34: cause = (char *)"No circuit/channel available"; break;
    case 38: cause = (char *)"Network out of order"; break;
    case 39: cause = (char *)"Permanent frame mode connection out of service"; break;
    case 40: cause = (char *)"Permanent frame mode connection operational"; break;
    case 41: cause = (char *)"Temporary failure"; break;
    case 42:
        cause = (char *)"Switching equipment congestion";
        break;
        /* TODO: Finish the rest of these */
    default: cause = (char *)"Unknown";
    }
...
static FUNC_SEND(calling_party_num_transmit)
{
    ...
    parm[1] = (1 << 4) |                         /* Assume E.164 ISDN numbering plan, calling number complete */
              ((msg->presentation_ind & 0x3) << 2) | (msg->screening_ind & 0x3);
...
static FUNC_DUMP(originating_line_information_dump)
{
    ...
    switch (parm[0]) {
    case 0:  name = (char *)" Plain Old Telephone Service POTS"; break;
    case 1:  name = (char *)" Multiparty line"; break;
    case 2:  name = (char *)" ANI Failure"; break;
    case 3:
    case 4:
    case 5:  name = (char *)" Unassigned"; break;
    case 6:  name = (char *)" Station Level Rating"; break;
    case 7:  name = (char *)" Special Operator Handling Required"; break;
    case 8:
    case 9:  name = (char *)"Unassigned"; break;
    case 10: name = (char *)"Not assignable"; break;
    case 11: name = (char *)"Unassigned"; break;
    case 12:
    case 13:
    case 14:
    case 15:
    ...
    case 17:
    case 18:
    case 19: name = (char *)"Not assignable"; break;
    case 20: name = (char *)"Automatic Identified Outward Dialing"; break;
    case 21:
    case 22: name = (char *)"Unassigned"; break;
    case 23: name = (char *)"Coin or Non-Coin"; break;
    case 24:
    case 25: name = (char *)"Toll Free Service translated to POTS"; break;
    case 26: name = (char *)"Unassigned"; break;
    case 27: name = (char *)"Pay Station using Coin Control Signalling"; break;
    case 28: name = (char *)"Unassigned"; break;
    case 29: name = (char *)"Prison/Inmate Service"; break;
    case 30:
    case 31:
    case 32: name = (char *)"Intercept"; break;
    case 33: name = (char *)"Unassigned"; break;
    case 34: name = (char *)"Telco Operator Handled Call"; break;
    case 35:
    case 36:
    case 37:
    case 38:
    case 39: name = (char *)"Unassigned"; break;
    case 40:
    case 41:
    case 42:
    case 43:
    ...
    case 47:
    case 48:
    case 49: name = (char *)"Unrestricted Use - locally determined by carrier"; break;
    case 50:
    case 51: name = (char *)"Unassigned"; break;
    case 52: name = (char *)"OUTWATS"; break;
    case 53:
    case 54:
    case 55:
    case 56:
    case 57:
    case 58:
    case 59: name = (char *)"Unassigned"; break;
    case 60: name = (char *)"TRS Unrestricted Line"; break;
    case 61: name = (char *)"Cellular Wireless PCS Type 1"; break;
    case 62: name = (char *)"Cellular Wireless PCS Type 2"; break;
    case 63: name = (char *)"Cellular Wireless PCS Roaming"; break;
    case 64:
    case 65: name = (char *)"Unassigned"; break;
    case 66: name = (char *)"TRS Hotel Motel"; break;
    case 67: name = (char *)"TRS Restricted Line"; break;
    case 68:
    case 69: name = (char *)"Unassigned"; break;
    case 70: name = (char *)"Pay Station No network Coin Control Signalling"; break;
    case 71:
    case 72:
    case 73:
    case 74:
    ...
    case 77:
    case 78:
    case 79: name = (char *)"Unassigned"; break;
    case 80:
    case 81:
    case 82:
    case 83:
    ...
    case 87:
    case 88:
    case 89: name = (char *)"Reserved"; break;
    case 90:
    case 91:
    case 92: name = (char *)"Unassigned"; break;
    case 93: name = (char *)"Private Virtual Network Type of service call"; break;
    case 94:
    case 95:
    case 96:
    case 97:
    case 98:
    case 99: name = (char *)"Unassigned"; break;

    default: name = (char *)"Unknown to Asterisk ";
    }
...
static FUNC_SEND(charge_number_transmit) // ANSI network
{
    ...
    isup_put_number(&parm[2], msg->charge_number, &datalen,
                    &oddeven); /* use the value from callerid in sip.conf to fill charge number */

    parm[0] =
        (oddeven << 7) |
        msg->charge_nai; /* Nature of Address Indicator = odd/even and ANI of the Calling party, subscriber number */
    parm[1] = (1 << 4) | 0x0; // msg->charge_num_plan    /* Assume E.164 ISDN numbering plan, calling number complete
                              // and make sure reserved bits are zero */
...
static FUNC_DUMP(circuit_group_supervision_dump)
{
    ...
    switch (parm[0] & 0x3) {
    case 0:  name = (char *)"Maintenance oriented"; break;
    case 1:  name = (char *)"Hardware Failure oriented"; break;
    case 2:  name = (char *)"Reserved for national use"; break;
    case 3:  name = (char *)"Spare"; break;
    default: name = (char *)"Huh?!";
    }
...
static FUNC_DUMP(event_info_dump)
{
    ...
    switch (parm[0]) {
    case 0:  name = (char *)"spare"; break;
    case 1:  name = (char *)"ALERTING"; break;
    case 2:  name = (char *)"PROGRESS"; break;
    case 3:  name = (char *)"In-band information or an appropriate pattern is now available"; break;
    case 4:  name = (char *)"Call forward on busy"; break;
    case 5:  name = (char *)"Call forward on no reply"; break;
    case 6:  name = (char *)"Call forward unconditional"; break;
    default: name = (char *)"Spare"; break;
    }
    DBG("\t%s", name);
    return 1;
}
...
static FUNC_DUMP(redirection_info_dump)
{
    ...
    switch (parm[0] & 0x7) {
    case 0: redirect_ind = (char *)"No Redirection (national use)"; break;
    case 1: redirect_ind = (char *)"Call rerouted (national use)"; break;
    case 2:
        redirect_ind = (char *)"Call rerouted, all rediection information presentation restricted (national use)";
        break;
    case 3:  redirect_ind = (char *)"Call diverted"; break;
    case 4:  redirect_ind = (char *)"Call diverted, all redirection information presentation restricted"; break;
    case 5:  redirect_ind = (char *)"Call rerouted, redirection number presentation restricted (national use)"; break;
    case 6:  redirect_ind = (char *)"Call diversion, redirection number presentation restricted (national use)"; break;
    case 7:  redirect_ind = (char *)"spare"; break;
    default: redirect_ind = (char *)"Unknown"; break;
    }

    DBG("\tRedirecting indicator: %s (%d)", redirect_ind, parm[0] & 0x7);

    switch ((parm[0] >> 4) & 0xf) {
    case 0:  orig_redir_reas = (char *)"Unknown/not available"; break;
    case 1:  orig_redir_reas = (char *)"User busy (national use)"; break;
    case 2:  orig_redir_reas = (char *)"No reply (national use)"; break;
    case 3:  orig_redir_reas = (char *)"Unconditional (national use)"; break;
    default: orig_redir_reas = (char *)"spare"; break;
    }
    ...
    switch ((parm[1] >> 4) & 0xf) {
    case 0:  redir_reas = (char *)"Unknown/not available"; break;
    case 1:  redir_reas = (char *)"User busy"; break;
    case 2:  redir_reas = (char *)"No reply"; break;
    case 3:  redir_reas = (char *)"Unconditional"; break;
    case 4:  redir_reas = (char *)"Deflection during alerting"; break;
    case 5:  redir_reas = (char *)"Deflection immediate response"; break;
    case 6:  redir_reas = (char *)"Mobile subscriber not reachable"; break;
    default: redir_reas = (char *)"spare"; break;
    }
...
static FUNC_SEND(generic_name_transmit)
{
    ...
    parm[0] = (msg->generic_name_typeofname << 5) | ((msg->generic_name_avail & 0x1) << 4) |
              (msg->generic_name_presentation & 0x3);
...
static FUNC_SEND(generic_address_transmit)
{
    ...
    parm[2] = (msg->gen_add_num_plan << 4) | ((msg->gen_add_pres_ind & 0x3) << 2) | (0x00 & 0x3);
...
static FUNC_DUMP(echo_control_info_dump)
{
    ...
    switch (ba) {
    case 0:  ba_str = (char *)"no information"; break;
    case 1:  ba_str = (char *)"outgoing echo control device not included and not available"; break;
    case 2:  ba_str = (char *)"outgoing echo control device included"; break;
    case 3:  ba_str = (char *)"outgoing echo control device not included but available"; break;
    default: ba_str = (char *)"unknown"; break;
    }

    switch (dc) {
    case 0:  dc_str = (char *)"no information"; break;
    case 1:  dc_str = (char *)"incoming echo control device not included and not available"; break;
    case 2:  dc_str = (char *)"incoming echo control device included"; break;
    case 3:  dc_str = (char *)"incoming echo control device not included but available"; break;
    default: dc_str = (char *)"unknown"; break;
    }

    switch (fe) {
    case 0:  fe_str = (char *)"no information"; break;
    case 1:  fe_str = (char *)"outgoing echo control device activation request"; break;
    case 2:  fe_str = (char *)"outgoing echo control device deactivation request"; break;
    case 3:  fe_str = (char *)"spare"; break;
    default: fe_str = (char *)"unknown"; break;
    }

    switch (hg) {
    case 0:  hg_str = (char *)"no information"; break;
    case 1:  hg_str = (char *)"incoming echo control device activation request"; break;
    case 2:  hg_str = (char *)"incoming echo control device deactivation request"; break;
    case 3:  hg_str = (char *)"spare"; break;
    default: hg_str = (char *)"unknown"; break;
    }
...
static FUNC_DUMP(circuit_state_ind_dump)
{
    ...
    for (i = 0; i < len; i++) {
        ...
        if (dcbits == 0) {
            switch (babits) {
            case 0: ba_str = (char *)"transient"; break;
            case 1:
            case 2: ba_str = (char *)"spare"; break;
            case 3: ba_str = (char *)"unequipped"; break;
            }
        } else {
            switch (babits) {
            case 0: ba_str = (char *)"no blocking (active)"; break;
            case 1: ba_str = (char *)"locally blocked"; break;
            case 2: ba_str = (char *)"remotely blocked"; break;
            case 3: ba_str = (char *)"locally and remotely blocked"; break;
            }

            switch (dcbits) {
            case 1: dc_str = (char *)"circuit incoming busy"; break;
            case 2: dc_str = (char *)"circuit outgoing busy"; break;
            case 3: dc_str = (char *)"idle"; break;
            }

            switch (febits) {
            case 0: fe_str = (char *)"no blocking (active)"; break;
            case 1: fe_str = (char *)"locally blocked"; break;
            case 2: fe_str = (char *)"remotely blocked"; break;
            case 3: fe_str = (char *)"locally and remotely blocked"; break;
            }
        }
...
static struct parm_func parms[] = {
    { ISUP_PARM_NATURE_OF_CONNECTION_IND, "Nature of Connection Indicator", nature_of_connection_ind_dump,
     nature_of_connection_ind_receive, nature_of_connection_ind_transmit },
    { ISUP_PARM_FORWARD_CALL_IND, "Forward Call Indicators", forward_call_ind_dump, forward_call_ind_receive,
     forward_call_ind_transmit },
    { ISUP_PARM_CALLING_PARTY_CAT, "Calling Party's Category", calling_party_cat_dump, calling_party_cat_receive,
     calling_party_cat_transmit },
    { ISUP_PARM_TRANSMISSION_MEDIUM_REQS, "Transmission Medium Requirements", transmission_medium_reqs_dump,
     transmission_medium_reqs_receive, transmission_medium_reqs_transmit },
    { ISUP_PARM_USER_SERVICE_INFO, "User Service Information", NULL, user_service_info_receive,
     user_service_info_transmit },
    { ISUP_PARM_CALLED_PARTY_NUM, "Called Party Number", called_party_num_dump, called_party_num_receive,
     called_party_num_transmit },
    { ISUP_PARM_CAUSE, "Cause Indicator", cause_dump, cause_receive, cause_transmit },
    { ISUP_PARM_CONTINUITY_IND, "Continuity Indicator", continuity_ind_dump, continuity_ind_receive,
     continuity_ind_transmit },
    { ISUP_PARM_ACCESS_TRANS, "Access Transport", access_transport_dump, access_transport_receive,
    ...
    { ISUP_PARM_CALLING_PARTY_NUM, "Calling Party Number", calling_party_num_dump, calling_party_num_receive,
     calling_party_num_transmit },
    { ISUP_PARM_CARRIER_ID, "Carrier Identification", carrier_identification_dump, carrier_identification_receive,
    ...
    { ISUP_PARM_GENERIC_ADDR, "Generic Address", generic_address_dump, generic_address_receive,
     generic_address_transmit },
    { ISUP_PARM_GENERIC_DIGITS, "Generic Digits", generic_digits_dump, generic_digits_receive,
    ...
    { ISUP_PARM_PROPAGATION_DELAY, "Propagation Delay Counter", propagation_delay_cntr_dump,
     propagation_delay_cntr_receive },
    { ISUP_PARM_HOP_COUNTER, "Hop Counter", hop_counter_dump, hop_counter_receive, hop_counter_transmit },
    { ISUP_PARM_BACKWARD_CALL_IND, "Backward Call Indicator", backward_call_ind_dump, backward_call_ind_receive,
     backward_call_ind_transmit },
    { ISUP_PARM_OPT_BACKWARD_CALL_IND, "Optional Backward Call Indicator", opt_backward_call_ind_dump,
     opt_backward_call_ind_receive, NULL },
    { ISUP_PARM_CIRCUIT_GROUP_SUPERVISION_IND, "Circuit Group Supervision Indicator", circuit_group_supervision_dump,
     circuit_group_supervision_receive, circuit_group_supervision_transmit },
    { ISUP_PARM_RANGE_AND_STATUS, "Range and status", range_and_status_dump, range_and_status_receive,
    ...
    { ISUP_PARM_ORIG_LINE_INFO, "Originating line information", originating_line_information_dump,
    ...
    { ISUP_PARM_ORIGINAL_CALLED_NUM, "Original called number", original_called_num_dump, original_called_num_receive,
    ...
    { ISUP_PARM_CIRCUIT_STATE_IND, "Circuit State Indicator", circuit_state_ind_dump, NULL,
     circuit_state_ind_transmit },
    { ISUP_PARM_LOCAL_SERVICE_PROVIDER_IDENTIFICATION, "Local Service Provider ID", lspi_dump, lspi_receive,
     lspi_transmit },
    { ISUP_PARM_FACILITY_IND, "Facility Indicator", facility_ind_dump, facility_ind_receive, facility_ind_transmit },
    { ISUP_PARM_REDIRECTING_NUMBER, "Redirecting Number", redirecting_number_dump, redirecting_number_receive,
...
int AmISUP::parse(const AmMimeBody *body)
{
    ...
    if (proto_type != SS7_ANSI and proto_type != SS7_ITU) {
        ERROR("unsupported SS7 standard: %s", proto_type_get_str(proto_type));
        return -1;
    }
...
int AmISUP::parse_mime(const AmMimeBody *body)
{
    ...
    for (AmContentType::Params::const_iterator i = ct.params.begin(); i != ct.params.end(); i++) {
    ...
    DBG("got ISUP payload version: '%s', base: '%s'", version.c_str(), base_version.c_str());

    proto_type = get_isup_proto_type(version);
    if (SS7_UNKNOWN == proto_type) {
        DBG("unsupported ISUP payload version '%s'. try failover to base", version.c_str());
        ...
        if (SS7_UNKNOWN == proto_type) {
            ERROR("unsupported ISUP payload base_version '%s'. give up", base_version.c_str());
            return -1;
        }
    }
...
int AmISUP::parse_payload(const char *buf, size_t len)
{
    ...
    if (proto_type == SS7_ANSI) {
        ...
        case ISUP_IAM:
            ...
            break;
        case ISUP_RLC: optparams = 0; break;
        default:       break;
        }
    }
    ...
    if (optparams && *opt_ptr) {
        while ((len > 0) && (mh->data[offset] != 0)) {
            ...
            if (res < 0) {
                WARN("Unhandled optional parameter 0x%x '%s'", optparm->type, param2str(optparm->type));
                res = optparm->len + 2;
            }
            len -= res;
            offset += res;
...
int AmISUP::parse_param(int parm, const char *parmbuf, size_t maxlen, isup_parm_type parmtype)
{
    ...
    for (x = 0; x < totalparms; x++) {
        ...
        if (parms[x].receive) {
            switch (parmtype) {
            case PARM_TYPE_FIXED: len = parms[x].receive(this, message_type, (unsigned char *)parmbuf, maxlen);
#ifdef DUMP_ON_PARSING
                if (parms[x].dump)
                    parms[x].dump(this, message_type, (unsigned char *)parmbuf, maxlen);
#endif
                break;
            case PARM_TYPE_VARIABLE: parms[x].receive(this, message_type, (unsigned char *)parmbuf + 1, parmbuf[0]);
#ifdef DUMP_ON_PARSING
                if (parms[x].dump)
            ...
            switch (parmtype) {
            case PARM_TYPE_VARIABLE: len = parmbuf[0] + 1; break;
            case PARM_TYPE_OPTIONAL:
                optparm = (struct isup_parm_opt *)parmbuf;
                len     = optparm->len + 2;
                break;
            case PARM_TYPE_FIXED: WARN("missed receive function for fixed param of type: 0x%02x", parm); break;
            }
        }
        return len;
    }
...
void AmISUP::dump() const
{
    ...
    s << "message_type: 0x" << std::setw(2) << std::hex << hex << " (" << message2str(message_type) << ")" << std::endl;
