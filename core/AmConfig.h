...
struct AmConfig
{
  ...
  static int parse_log_level(const string& level);
  ...
  static string PcapUploadQueueName;

  static bool enableRTSP;
  ...
  /** Setter for StderrLoglevel, returns 0 on invalid value */
  static int setStderrLogLevel(const string& level, bool apply=true);
