...
{
    int res;
    enum { TR_BEG, TR_UDP, TR_T, TR_W, TR_TCP, TR_TLS, TR_SCTP, TR_WS, TR_WSS, TR_OTHER };
...
{
    enum { BY_HOST = 0, BY_HOST_V6, BY_COLON, BY_PORT_SWS, BY_PORT };
    ...
    for (; *c != end; (*c)++) {
        ...
        case BY_HOST_V6:
            ...
            case HTAB:
            case CR:
            case LF:   DBG("Bad character in IPv6 address (0x%x)", **c); return MALFORMED_SIP_MSG;
            }
            break;
        ...
        case BY_COLON:
            ...
            default:   DBG("LWS expected"); return MALFORMED_SIP_MSG;
            }
            break;
...
end_by:
    ...
    case ST_CRLF:
        switch (saved_st) {
        case BY_PORT: v->port.set(beg, *c - (st == ST_CRLF ? 2 : 1) - beg); break;
        }
        break;

    case BY_COLON: break;

    default:       DBG("Unexpected end state: st = %i", st); return UNDEFINED_ERR;
    }
...
{
    switch (transport_id) {
    case sip_transport::UDP:  return "udp";
    case sip_transport::TCP:  return "tcp";
    case sip_transport::TLS:  return "tls";
    case sip_transport::WS:   return "ws";
    case sip_transport::WSS:  return "wss";
    case sip_transport::SCTP: return "sctp";
    }
    return "";
}
