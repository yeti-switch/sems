...
class trsp_socket : public atomic_ref_cnt {
  public:
    ...
    enum socket_transport_addr_family { tr_addr_family_ipv4 = 0, tr_addr_family_ipv6 = sock_transport_addr_shift(1) };
  ...
  public:
    trsp_socket(unsigned short if_num, unsigned short proto_idx, unsigned int opts, socket_transport trans,
...
class trsp_acl {
  public:
    enum action_t { Allow = 0, Drop, Reject };
