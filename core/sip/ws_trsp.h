...
class ws_output {
  public:
    ...
    virtual void    copy_addrs(sockaddr_storage *sa_local, sockaddr_storage *sa_remote, unsigned int &protocol_id) = 0;
};
...
class ws_input : public trsp_base_input {
  ...
  public:
    ...
    bool               is_connection_close() { return connection_close; }
...
class ws_trsp_socket : public ws_output, public tcp_trsp_socket {
    ...
    virtual void copy_addrs(sockaddr_storage *sa_local, sockaddr_storage *sa_remote, unsigned int &protocol_id)
    {
  ...
  protected:
    ...
    ws_trsp_socket(trsp_server_socket *server_sock, trsp_worker *server_worker, int sd, const sockaddr_storage *sa,
